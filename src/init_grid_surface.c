...
void quitGraphics(sudoku *sudoku_tab)
{
    ...
    SDL_DestroyTexture(sudoku_tab -> level_one);
    SDL_DestroyTexture(sudoku_tab -> level_two);
    SDL_DestroyTexture(sudoku_tab -> level_three);
    SDL_DestroyTexture(sudoku_tab -> level_four);
    SDL_DestroyTexture(sudoku_tab -> level_five);
